...
import 'package:weather/src/firebase/home_page.dart';
import 'package:weather/src/firebase/ml_weather_prediction.dart';
          ...
          actions: <Widget>[
            PopupMenuButton<OptionsMenu>(
                ...
                itemBuilder: (context) => <PopupMenuEntry<OptionsMenu>>[
                      ...
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.realtimedata,
                        child: Text("Real Time Data"),
                      ),
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.mldata,
                        child: Text("ML Prediction"),
                      ),
                    ])
          ],
        ),
  ...
  _onOptionMenuItemSelected(OptionsMenu item) {
    switch (item) {
      ...
      case OptionsMenu.settings:
        ...
        break;
      case OptionsMenu.realtimedata:
        Navigator.push(context, MaterialPageRoute(builder: (context) => RealTimeData()));
        break;
      case OptionsMenu.mldata:
        Navigator.push(context, MaterialPageRoute(builder: (context) => MLPredictionData()));
        break;
    }
  }
